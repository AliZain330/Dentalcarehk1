export const translations = {
  en: {
    ...
    booking: {
      ...
      paymentSuccessDesc: "Your appointment has been booked successfully",
    ...
    orderManagement: {
      ...
      partialRefund: "partial refund (30% penalty)",
      noRefund: "No refund (treatment started)",
      moreThan24h: "More than 24 hours before appointment",
      within24h: "Within 24 hours of appointment",
      treatmentStarted: "Treatment has started",
    ...
    review: {
      title: "Write Review",
      envRating: "Environment",
      serviceRating: "Service Quality",
      doctorSkill: "Doctor Competence",
      doctorAttitude: "Doctor Attitude",
      comment: "Your Review",
    ...
    orders: {
      title: "My Orders", all: "All", pending: "Pending", confirmed: "Confirmed", completed: "Completed", cancelled: "Cancelled", empty: "No orders yet", emptyDesc: "Your appointment orders will appear here",
    },
    reports: { title: "Diagnosis Reports", empty: "No reports yet", emptyDesc: "Your diagnosis reports will appear here after your visits" },
  ...
  "zh-HK": {
    ...
    orderManagement: {
      title: "我的訂單",
      all: "全部",
      pendingAcceptance: "待確認",
      pendingTreatment: "待治療",
      completed: "已完成",
      cancelled: "已取消",
      empty: "暫無訂單",
      ...
      writeReview: "撰寫評價",
      cancelConfirm: "取消預約",
      cancelWarning: "您確定要取消此預約嗎？",
      cancellationPolicy: "取消政策",
      fullRefund: "全額退款",
      partialRefund: "部分退款（30%罰款）",
      noRefund: "不予退款（治療已開始）",
      moreThan24h: "預約24小時前取消",
      within24h: "預約24小時內取消",
      treatmentStarted: "治療已開始",
      refundAmount: "退款金額",
      confirmCancel: "確認取消",
    ...
    reports: { title: "診斷報告", empty: "暫無報告", emptyDesc: "您的診斷報告將於就診後顯示" },
