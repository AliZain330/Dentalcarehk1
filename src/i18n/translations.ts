export const translations = {
  ...
  "zh-HK": {
    ...
    institution: {
      infoTitle: "機構資訊", infoSubtitle: "管理您的機構公開資料",
      basicInfo: "基本資訊", introduction: "機構簡介", businessHours: "營業時間",
      contactPhone: "聯絡電話", transport: "交通指引", address: "地址",
      mapPlaceholder: "地圖定位校準",
      photoMgmt: "照片管理", addSlot: "新增", upload: "上傳", replace: "替換",
      storefront: "門面", reception: "接待區", treatmentRoom: "診療室", equipment: "設備", waitingArea: "候診區",
      uploaded: "已啟用", pending: "待上傳", empty: "空",
      serviceMgmt: "服務管理", serviceMgmtSubtitle: "管理您的機構服務項目",
      addService: "新增服務", editService: "編輯服務", totalServices: "總服務數",
      listed: "已上架", unlisted: "已下架",
      serviceName: "服務名稱", nameEN: "名稱（英文）", nameZH: "名稱（中文）",
      descEN: "描述（英文）", descZH: "描述（中文）",
      price: "價格 (HKD)", duration: "時長（分鐘）", population: "適用人群（英文）", populationZH: "適用人群（中文）",
      serviceImages: "服務圖片", bookingCount: "預約數",
      deleteWarning: "無法刪除有活躍預約的服務，請改為下架。",
      activeBookings: "存在活躍預約", noServicesFound: "找不到服務",
      searchServices: "搜尋服務...", allStatus: "全部狀態",
    },
  },
};
