    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4">
      <Card className="w-full max-w-sm border-0 shadow-md">
        <CardContent className="flex flex-col items-center p-8 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">{t.consultation.consultationCreated}</p>
          {orderNumber && (
          ...
          <div className="mt-6 flex w-full flex-col gap-2">
            <Button onClick={() => navigate(`/consultation/order/${orderId}`)} className="w-full">{t.booking.viewOrder}</Button>
